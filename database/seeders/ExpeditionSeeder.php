...
class ExpeditionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $nanga_parbat_expedition_data = Expedition::create([
            'title' => [
                'en' => 'Mt. Nanga Parbat Expedition (8125m)',
                'fr' => 'Expédition au Mont Nanga Parbat (8125m)', // Example French translation
            ],
            'description' => [
        ...
        $annapurna_i_expedition_data = Expedition::create([
            'title' => [
                'en' => 'Mt. Annapurna I Expedition (8091m)',
                'fr' => 'Expédition au Mont Annapurna I (8091m)', // Example French translation
            ],
            'description' => [
