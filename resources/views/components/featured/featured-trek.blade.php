...
@if ($treks->where('is_featured', true)->count() >= 3)
    <div class="w-full bg-blue-100/50">
        <div class="h-6 "></div>
        <div class="lg:grid grid-cols-4 gap-2 2xl:mx-44 mx-4">
            <div
                class="card sm:max-w-sm bg-blue-300 bg-opacity-100 hidden lg:flex  overflow-hidden bg-gradient-to-r from-blue-300 to-green-100 bg-clip h-[30rem]">
