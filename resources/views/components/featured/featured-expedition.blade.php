<div class="bg-blue-100/20">
    ...
    <div class="2xl:mx-44 mx-4 ">
        ...
        <h3 class="text-4xl tracking-widest text-accent ">Expeditions</h3>
        <p
            class="text-md   mt-2 text-preety text-balance text-blue-800 md:text-wrap md:text-justify first-line:uppercase first-line:tracking-widest first-line:font-light ">
...
@if ($expeditions->where('is_featured', true)->count() >= 3)
    <div class="w-full bg-blue-100/20">
        <div class="h-6 "></div>
            ...
            @foreach ($expeditions->where('is_featured', true) as $featuredExpedition)
                <div
                    ...
                    <a href="{{ route('show_expedition', $featuredExpedition->id) }}">
                        <div class="card-body absolute inset-0 justify-center">
                            <div class="card-body absolute inset-0 justify-end  ">
                                <div class="text-center backdrop-blur-md italic">
                                    <h2 class="font-bold text-white  text-4xl">
                                        {{ $featuredExpedition->title }}
                                    </h2>
                                    <h2 class="font-bold tracking-normal text-white line-clamp-2  text-4xl">
                                        {{ $featuredExpedition->highest_altitude }} m
                                    </h2>
                                </div>
                            </div>
