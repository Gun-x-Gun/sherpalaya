            ...
            <div class="flex flex-col md:grid grid-cols-2 md:gap-2 bg-transparent ">
                @foreach ($featuredTreks->slice(0, 2) as $featuredTrek)
                    @if ($loop->index % 2 === 0)
                        ...
                        <div class="card rounded-none font-oswald image-full w-full h-full relative flex items-center card-side group hover:shadow border"
                            data-aos="fade-down" data-aos-duration="1200">
                ...
                @foreach ($featuredTreks->slice(3, 10) as $featuredTrek)
                    ...
                    <div class="card rounded-none font-oswald image-full w-full h-full relative flex items-center card-side group hover:shadow border col-span-1 "
                        ...
                        <a href="{{ route('show_trek', $featuredTrek->id) }}">
                            <div class="card-body absolute inset-0 justify-center md:justify-center">
                                <div class="text-center ">
                                    <h2 class="font-bold text-blue-50 text-2xl md:text-2xl uppercase">
                                        {{ $featuredTrek->title }}
                                    </h2>
                                    <h2
                                        class="font-bold tracking-normal text-blue-50 uppercase line-clamp-2 text-2xl md:text-2xl">
                                        {{ $featuredTrek->highest_altitude }} m
                                    </h2>
                                </div>
                            </div>
