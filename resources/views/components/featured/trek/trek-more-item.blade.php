        ...
        <div class="xl:mx-32 mx-4 font-body">
            ...
            <div class="flex flex-col md:grid grid-cols-2 md:gap-2 bg-transparent ">
                @foreach ($featuredTreks->slice(0, 2) as $featuredTrek)
                    @if ($loop->index % 2 === 0)
                        ...
                        <div class="card rounded-none font-body image-full w-full h-full relative flex items-center card-side group hover:shadow border"
                            >
                            ...
                            <a href="{{ route('show_trek', $featuredTrek->id) }}">
                                <div class="card-body absolute inset-0 justify-center md:justify-center">
                                    <div class="text-center " data-aos="fade-down" data-aos-duration="800">
                                        <h2 class="font-medium text-blue-50 text-3xl md:text-3xl uppercase group-hover:text-warning">
                                            {{ $featuredTrek->title }}
                                        </h2>
                                        <h2
            ...
            <div class="hidden md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-2 bg-blue-100/10 ">
                @foreach ($featuredTreks->slice(3, 10) as $featuredTrek)
                    {{-- First Iteration: col-span-1 on the text and col-span-2 on the image --}}
                    <div class="card rounded-none font-body image-full w-full h-full relative flex items-center card-side group hover:shadow border col-span-1 "
                        >
                        <figure class="h-[28rem] w-full ">
                            <img src="{{ optional($featuredTrek->featureImage)->url ?? asset('photos/DSCF2600.JPG') }}"
                                alt="{{ $featuredTrek->title }} Cover Image"
                        ...
                        <a href="{{ route('show_trek', $featuredTrek->id) }}">
                            <div class="card-body absolute inset-0 justify-center md:justify-center">
                                <div class="text-center " data-aos="fade-down" data-aos-duration="1200">
                                    <h2 class="font-medium tracking-tight text-blue-50 text-2xl md:text-2xl uppercase group-hover:text-warning">
                                        {{ $featuredTrek->title }}
                                    </h2>
                                    <h2
                                        ...
                                        <a href="{{ route('show_trek', $featuredTrek->id) }}">
                                            <div class="card-body absolute inset-0 justify-end">
                                                <div class="text-center">
                                                    <h2 class="font-medium tracking-tight text-white text-2xl uppercase group-hover:text-warning">
                                                        {{ $featuredTrek->title }}
                                                    </h2>
                                                    <h2
