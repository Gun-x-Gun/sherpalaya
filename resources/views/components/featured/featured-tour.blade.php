<div class="bg-gray-300">
    ...
    <div class="2xl:mx-44 mx-4 ">
        <h5 class="text-base-content text-4xl font-semibold text-left line-clamp-2">Tours With Sherpalaya</h5>
        <p class="text-base-content/80 text-base text-left mt-2">
            Experience the best of Nepal’s diverse heritage with Sherpalaya’s customized tours. From the bustling
            streets of Kathmandu to the tranquil lakes of Pokhara and the wildlife safaris of Chitwan, Sherpalaya
            creates a seamless blend of adventure and relaxation. With expert guides, we help you uncover hidden gems,
            experience authentic Nepali culture, and make lifelong memories.
        </p>
    </div>
</div>
        ...
        <div class="lg:grid grid-cols-4 gap-2 2xl:mx-44 mx-4 h-[70vh]">
            <div
                ...
                <div class="card-body  justify-center items-start">
                    <h5 class="card-title mb-2.5 line-clamp-2">Featured tours</h5>
                    <p class="mb-4 text-secondary text-pretty line-clamp-4 ">
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nihil perspiciatis, eligendi, odit
                        assumenda, fugit ad laboriosam distinctio modi tempore reiciendis quisquam explicabo repudiandae
                        suscipit maiores quidem quas cupiditate blanditiis dolorem.
                    </p>
                        ...
                        <div class="carousel-slide lg:hidden flex">
                            <div
                                ...
                                <div class="card-body justify-center text-left">
                                    <h5 class="card-title mb-2.5">Featured tours</h5>
                                    <p class="mb-4 text-secondary  text-pretty line-clamp-4">
                        ...
                        @foreach ($tours->where('is_featured', true) as $featuredTour)
                            <div class="carousel-slide h-[70vh]">
                                <div
                                    ...
                                    <a href="{{ route('show_expedition', $featuredTour->id) }}">
    ...
    <div class="w-full bg-gray-300">
        ...
        <div class="lg:grid grid-cols-3 gap-2 2xl:mx-44 mx-4 hidden h-[70vh]">
            ...
            items-center justify-center relative">
                <span
                    class="icon-[simple-line-icons--graph] size-40 mb-4 rotate-12 opacity-20 absolute top-10 left-30 text-white ">
                </span>
                ...
                <div class="carousel-body opacity-0 gap-2 h-[70vh]">
                    <div class="carousel-slide lg:hidden flex ">
                        <div
                            ...
                            <div class="card-body items-start  justify-center p-4 ">
                                <span
                                    class="icon-[simple-line-icons--graph] size-40 mb-4 rotate-12 opacity-20 absolute top-5 left-5 text-white ">
                                </span>
                                <h5 class="card-title mb-2.5 line-clamp-2">Featured tours</h5>
                                <p class="w-full mb-4 text-secondary text-pretty line-clamp-4 text-left">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorum rerum aperiam non
                                    dolorem unde
                                    provident temporibus. Recusandae sed nihil ducimus rem vero fuga, quia consequatur
                                    asperiores iusto,
                                    illum natus modi.
                                </p>
                                <div class="card-actions">
