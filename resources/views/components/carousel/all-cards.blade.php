{{-- <div class="max-w-full bg-slate-300 ">
    <div class="h-16">
    </div>
    <div class="card-header font-extra-bold capitalize tracking-normal  text-center underline underline-offset-2 decoration-dashed w-full">
        <h5 class="card-title text-4xl  text-blue-800">
            Our Services </h5>
    </div>
    <div class="h-12">

    </div>
    <div class="lg:grid lg:grid-cols-2 gap-0 flex flex-col lg:max-[77%] 2xl:mx-44 md:grid md:grid-cols-1 mx-4 mb-4">
        <!-- Card 1 -->
        <div class="card card-side group hover:shadow border border-gray-200 rounded-none overflow-hidden border-none shadow-none bg-slate-400/20 lg:grid lg:grid-cols-2 md:grid md:grid-cols-2 flex flex-col "
            dir="ltr">
            <figure class="md:w-full lg:w-full w-full">
