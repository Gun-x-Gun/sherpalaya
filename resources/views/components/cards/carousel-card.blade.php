{{-- <div class="card image-full ">
    <figure class="border-0 rounded-none">
        <img src="{{ asset('images/swisnl/filament-backgrounds/curated-by-swis/02.jpg') }}"
            alt="overlay image rounded-none" />
    </figure>
    <div class="card-body text-center md:text-left md:pl-48 pt-[20rem]">
...
<div class="card--rounded-none image-full  bg-blue-100/50 h-[100vh]">
    <figure class="h-[100vh] w-full">
        <img src="{{  asset('/photos/qualitymount1.png') }}" alt="Trekking background image"
