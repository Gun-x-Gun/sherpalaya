...
<a href="{{ $bookingFor->getWhatsappUrl() }}" class="fixed bottom-5 right-10 z-auto text-right " target="_blank">
    <span class="icon-[ph--whatsapp-logo-duotone] size-15 text-green-600 hover:size-16"></span>
</a>
