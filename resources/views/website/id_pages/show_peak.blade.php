                        ...
                        @if (!empty($peak->key_highlights))
                            ...
                            <div id="key_highlights" class="card 2xl:max-w-full rounded-none bg-blue-100/10 ">
                                ...
                                <div class="card-body justify-center items-start px-2 ">
                                    @foreach ($peak->key_highlights as $highlight)
