        ...
        <div class="card-body relative ">
            <div
                ...
                <div class=" max-w-[92%] 2xl:max-w-[70%]">
                    ...
                    <h2 class="card-title mb-2.5  text-white  md:text-6xl uppercase font-bold">Explore Treks With
                    </h2>
                ...
                <div class="bg-blue-100/50">
                    <div class="2xl:mx-44 mx-4">
                        <div class="card  rounded-none  bg-transparent">
                            <div class="card-body flex flex-col md:flex-row lg:flex-row gap-10">
                                        ...
                                        <div class="accordion-item " id="itinerary-{{ $itinerary->id }}">
                                            ...
                                            <div id="itinerary-{{ $itinerary->id }}-collapse"
                                                ...
                                                <div class=" ">
                                                        ...
                                                        <div class="card-body justify-center items-start px-0">
                                                            @foreach ($itinerary->itineraryDetails as $detail)
                                                                @php
                                                                    ...
                                                                    $icon =
                                                                        $icons[$type] ?? 'icon-[tabler--help-circle]'; // Default icon if type is missing
                                                                @endphp
                                                                <h5
                                                    ...
                                                    <div class="">
                                                        <div class="card-body  bg-blue-100/20 w-full px-0 ">
                                                            <h5
                                                            ...
                                                            @foreach ($itinerary->destinations->take(2) as $destination)
                                                                <div class="md:grid grid-cols-2 flex flex-col gap-1">
                                                            ...
                                                            <div class="carousel-slide">
                                                                <div class="bg-base-200/50 flex h-full justify-center">
                                                                    <span class="self-start w-full ">
                                                                        <figure><img
                                                                                src="{{ $destinationImage->url ?? asset('photos/P1030127.JPG') }}"
                                                                                alt="{{ $destination->title }} Cover Image"
